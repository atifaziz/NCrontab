...
namespace NCrontab.Tests
{
    ...
    public sealed class CrontabScheduleTests
    {
        ...
        public void Evaluations_Next(string startTimeString, string cronExpression, string nextTimeString, bool includingSeconds)
        {
            CronCall_Next(startTimeString, cronExpression, nextTimeString, new ParseOptions
            {
        ...
        [TestCase("01/01/2003 00:01:00", "* * * * *", "01/01/2003 00:00:00", false)]
        [TestCase("01/01/2003 00:02:00", "* * * * *", "01/01/2003 00:01:00", false)]
        [TestCase("01/01/2003 00:03:00", "* * * * *", "01/01/2003 00:02:00", false)]
        [TestCase("01/01/2003 01:00:00", "* * * * *", "01/01/2003 00:59:00", false)]
        [TestCase("01/01/2003 02:00:00", "* * * * *", "01/01/2003 01:59:00", false)]
        [TestCase("02/01/2003 00:00:00", "* * * * *", "01/01/2003 23:59:00", false)]
        [TestCase("01/01/2004 00:00:00", "* * * * *", "31/12/2003 23:59:00", false)]

        [TestCase("01/03/2003 00:00:00", "* * * * *", "28/02/2003 23:59:00", false)]
        [TestCase("29/02/2004 00:00:00", "* * * * *", "28/02/2004 23:59:00", false)]

        //// Second tests

        [TestCase("01/01/2003 00:01:00", "45 * * * * *", "01/01/2003 00:00:45", true)]

        [TestCase("01/01/2003 00:02:00", "45-47,48,49 * * * * *", "01/01/2003 00:01:49", true)]
        [TestCase("01/01/2003 00:01:49", "45-47,48,49 * * * * *", "01/01/2003 00:01:48", true)]
        [TestCase("01/01/2003 00:01:48", "45-47,48,49 * * * * *", "01/01/2003 00:01:47", true)]
        [TestCase("01/01/2003 00:01:47", "45-47,48,49 * * * * *", "01/01/2003 00:01:46", true)]
        [TestCase("01/01/2003 00:01:46", "45-47,48,49 * * * * *", "01/01/2003 00:01:45", true)]
        [TestCase("01/01/2003 00:01:45", "45-47,48,49 * * * * *", "01/01/2003 00:00:49", true)]

        [TestCase("01/01/2003 00:02:00", "2/5 * * * * *", "01/01/2003 00:01:57", true)]
        [TestCase("01/01/2003 00:01:57", "2/5 * * * * *", "01/01/2003 00:01:52", true)]
        [TestCase("01/01/2003 00:01:10", "2/5 * * * * *", "01/01/2003 00:01:07", true)]
        [TestCase("01/01/2003 00:01:07", "2/5 * * * * *", "01/01/2003 00:01:02", true)]
        [TestCase("01/01/2003 00:01:02", "2/5 * * * * *", "01/01/2003 00:00:57", true)]

        //// See: https://github.com/atifaziz/NCrontab/issues/90
        [TestCase("24/02/2021 11:50:35", "* 0-1 10 * * *", "24/02/2021 10:01:59", true)]

        //// Minute tests

        [TestCase("01/01/2003 02:00:00", "45 * * * *", "01/01/2003 01:45:00", false)]

        [TestCase("01/01/2003 02:00:00", "45-47,48,49 * * * *", "01/01/2003 01:49:00", false)]
        [TestCase("01/01/2003 01:49:00", "45-47,48,49 * * * *", "01/01/2003 01:48:00", false)]
        [TestCase("01/01/2003 01:48:00", "45-47,48,49 * * * *", "01/01/2003 01:47:00", false)]
        [TestCase("01/01/2003 01:47:00", "45-47,48,49 * * * *", "01/01/2003 01:46:00", false)]
        [TestCase("01/01/2003 01:46:00", "45-47,48,49 * * * *", "01/01/2003 01:45:00", false)]
        [TestCase("01/01/2003 01:45:00", "45-47,48,49 * * * *", "01/01/2003 00:49:00", false)]

        [TestCase("01/01/2003 02:00:00", "2/5 * * * *", "01/01/2003 01:57:00", false)]
        [TestCase("01/01/2003 01:57:00", "2/5 * * * *", "01/01/2003 01:52:00", false)]
        [TestCase("01/01/2003 01:10:00", "2/5 * * * *", "01/01/2003 01:07:00", false)]
        [TestCase("01/01/2003 01:07:00", "2/5 * * * *", "01/01/2003 01:02:00", false)]
        [TestCase("01/01/2003 01:02:00", "2/5 * * * *", "01/01/2003 00:57:00", false)]

        //// See: https://github.com/atifaziz/NCrontab/issues/90
        [TestCase("24/02/2021 11:50:35", "* * 10 * * *", "24/02/2021 10:59:59", true)]
        [TestCase("24/02/2021 10:50:35", "* 55 * * * *", "24/02/2021 09:55:59", true)]

        [TestCase("01/01/2003 01:00:30", "3 45 * * * *", "01/01/2003 00:45:03", true)]

        [TestCase("01/01/2003 02:00:30", "6 45-47,48,49 * * * *", "01/01/2003 01:49:06", true)]
        [TestCase("01/01/2003 01:49:03", "6 45-47,48,49 * * * *", "01/01/2003 01:48:06", true)]
        [TestCase("01/01/2003 01:48:03", "6 45-47,48,49 * * * *", "01/01/2003 01:47:06", true)]
        [TestCase("01/01/2003 01:47:03", "6 45-47,48,49 * * * *", "01/01/2003 01:46:06", true)]
        [TestCase("01/01/2003 01:46:03", "6 45-47,48,49 * * * *", "01/01/2003 01:45:06", true)]
        [TestCase("01/01/2003 01:45:03", "6 45-47,48,49 * * * *", "01/01/2003 00:49:06", true)]

        [TestCase("01/01/2003 02:00:30", "9 2/5 * * * *", "01/01/2003 01:57:09", true)]
        [TestCase("01/01/2003 01:57:03", "9 2/5 * * * *", "01/01/2003 01:52:09", true)]
        [TestCase("01/01/2003 01:10:30", "9 2/5 * * * *", "01/01/2003 01:07:09", true)]
        [TestCase("01/01/2003 01:07:03", "9 2/5 * * * *", "01/01/2003 01:02:09", true)]
        [TestCase("01/01/2003 01:02:03", "9 2/5 * * * *", "01/01/2003 00:57:09", true)]

        //// Hour tests

        [TestCase("20/12/2003 12:00:00", " * 3/4 * * *", "20/12/2003 11:59:00", false)]
        [TestCase("20/12/2003 23:30:00", " * 3   * * *", "20/12/2003 03:59:00", false)]
        [TestCase("20/12/2003 22:45:00", "30 3   * * *", "20/12/2003 03:30:00", false)]

        //// Day of month tests

        [TestCase("01/02/2003 00:15:00", "30  *  1 * *", "01/01/2003 23:30:00", false)]
        [TestCase("01/01/2003 23:30:00", "30  *  1 * *", "01/01/2003 22:30:00", false)]

        [TestCase("25/01/2003 00:00:00", "10  * 22    * *", "22/01/2003 23:10:00", false)]
        [TestCase("25/01/2003 00:00:00", "30 23 19    * *", "19/01/2003 23:30:00", false)]
        [TestCase("25/01/2003 00:00:00", "30 23 21    * *", "21/01/2003 23:30:00", false)]
        [TestCase("25/01/2003 00:59:00", " *  * 21    * *", "21/01/2003 23:59:00", false)]
        [TestCase("31/07/2003 00:00:00", " *  * 30,31 * *", "30/07/2003 23:59:00", false)]

        //// Test month rollovers for months with 28,29,30 and 31 days

        [TestCase("01/03/2002 00:00:00", "* * * 2 *", "28/02/2002 23:59:00", false)]
        [TestCase("01/03/2004 00:00:00", "* * * 2 *", "29/02/2004 23:59:00", false)]
        [TestCase("01/04/2002 00:00:00", "* * * 3 *", "31/03/2002 23:59:00", false)]
        [TestCase("01/05/2002 00:00:00", "* * * 4 *", "30/04/2002 23:59:00", false)]

        //// Test month 30,31 days

        //January
        [TestCase("01/02/2000 00:00:00", "0 0 15,30,31 * *", "31/01/2000 00:00:00", false)]
        [TestCase("31/01/2000 00:00:00", "0 0 15,30,31 * *", "30/01/2000 00:00:00", false)]
        [TestCase("30/01/2000 00:00:00", "0 0 15,30,31 * *", "15/01/2000 00:00:00", false)]
        [TestCase("15/01/2000 00:00:00", "0 0 15,30,31 * *", "31/12/1999 00:00:00", false)]

        //February
        [TestCase("15/03/2000 00:00:00", "0 0 15,30,31 * *", "15/02/2000 00:00:00", false)]

        //March
        [TestCase("15/04/2000 00:00:00", "0 0 15,30,31 * *", "31/03/2000 00:00:00", false)]
        [TestCase("31/03/2000 00:00:00", "0 0 15,30,31 * *", "30/03/2000 00:00:00", false)]
        [TestCase("30/03/2000 00:00:00", "0 0 15,30,31 * *", "15/03/2000 00:00:00", false)]

        //April
        [TestCase("15/05/2000 00:00:00", "0 0 15,30,31 * *", "30/04/2000 00:00:00", false)]
        [TestCase("30/04/2000 00:00:00", "0 0 15,30,31 * *", "15/04/2000 00:00:00", false)]

        //May
        [TestCase("15/06/2000 00:00:00", "0 0 15,30,31 * *", "31/05/2000 00:00:00", false)]
        [TestCase("31/05/2000 00:00:00", "0 0 15,30,31 * *", "30/05/2000 00:00:00", false)]
        [TestCase("30/05/2000 00:00:00", "0 0 15,30,31 * *", "15/05/2000 00:00:00", false)]

        //June
        [TestCase("15/07/2000 00:00:00", "0 0 15,30,31 * *", "30/06/2000 00:00:00", false)]
        [TestCase("30/06/2000 00:00:00", "0 0 15,30,31 * *", "15/06/2000 00:00:00", false)]

        //July
        [TestCase("15/08/2000 00:00:00", "0 0 15,30,31 * *", "31/07/2000 00:00:00", false)]
        [TestCase("31/07/2000 00:00:00", "0 0 15,30,31 * *", "30/07/2000 00:00:00", false)]
        [TestCase("30/07/2000 00:00:00", "0 0 15,30,31 * *", "15/07/2000 00:00:00", false)]

        //August
        [TestCase("15/09/2000 00:00:00", "0 0 15,30,31 * *", "31/08/2000 00:00:00", false)]
        [TestCase("31/08/2000 00:00:00", "0 0 15,30,31 * *", "30/08/2000 00:00:00", false)]
        [TestCase("30/08/2000 00:00:00", "0 0 15,30,31 * *", "15/08/2000 00:00:00", false)]

        //September
        [TestCase("15/10/2000 00:00:00", "0 0 15,30,31 * *", "30/09/2000 00:00:00", false)]
        [TestCase("30/09/2000 00:00:00", "0 0 15,30,31 * *", "15/09/2000 00:00:00", false)]

        //October
        [TestCase("15/11/2000 00:00:00", "0 0 15,30,31 * *", "31/10/2000 00:00:00", false)]
        [TestCase("31/10/2000 00:00:00", "0 0 15,30,31 * *", "30/10/2000 00:00:00", false)]
        [TestCase("30/10/2000 00:00:00", "0 0 15,30,31 * *", "15/10/2000 00:00:00", false)]

        //November
        [TestCase("15/12/2000 00:00:00", "0 0 15,30,31 * *", "30/11/2000 00:00:00", false)]
        [TestCase("30/11/2000 00:00:00", "0 0 15,30,31 * *", "15/11/2000 00:00:00", false)]

        //December
        [TestCase("15/01/2001 00:00:00", "0 0 15,30,31 * *", "31/12/2000 00:00:00", false)]
        [TestCase("31/12/2000 00:00:00", "0 0 15,30,31 * *", "30/12/2000 00:00:00", false)]
        [TestCase("30/12/2000 00:00:00", "0 0 15,30,31 * *", "15/12/2000 00:00:00", false)]

        //// Other month tests (including year rollover)

        [TestCase("01/01/2003 05:00:00", "10 * * 6 *", "30/06/2002 23:10:00", false)]
        [TestCase("15/02/2003 00:00:00", " 1 2 3 * *", "03/02/2003 02:01:00", false)]
        [TestCase("01/01/2002 05:00:00", "10 * * February,April-Jun *", "30/06/2001 23:10:00", false)]
        [TestCase("01/12/2003 00:00:00", "0 12 1 6 *", "01/06/2003 12:00:00", false)]
        [TestCase("11/02/1990 14:23:00", "* 12 1 6 *", "01/06/1989 12:59:00", false)]
        [TestCase("11/09/1988 14:23:00", "* 12 1 6 *", "01/06/1988 12:59:00", false)]
        [TestCase("11/09/1988 14:23:00", "* 2,4-8,15 * 6 *", "30/06/1988 15:59:00", false)]
        [TestCase("11/09/1988 14:23:00", "20 * * january,FeB,Mar,april,May,JuNE,July,Augu,SEPT-October,Nov,DECEM *", "11/09/1988 14:20:00", false)]

        //// Day of week tests

        [TestCase("01/07/2003 10:00:00", "30 6 * * 0", "29/06/2003 06:30:00", false)]
        [TestCase("01/07/2003 10:00:00", "30 6 * * sunday", "29/06/2003 06:30:00", false)]
        [TestCase("01/07/2003 10:00:00", "30 6 * * SUNDAY", "29/06/2003 06:30:00", false)]
        [TestCase("29/06/2003 00:00:00", "1 12 * * 2", "24/06/2003 12:01:00", false)]
        [TestCase("08/07/2003 12:01:00", "1 12 * * 2", "01/07/2003 12:01:00", false)]

        [TestCase("03/06/2003 14:55:00", "15 18 * * Mon", "02/06/2003 18:15:00", false)]
        [TestCase("16/06/2003 18:15:00", "15 18 * * Mon", "09/06/2003 18:15:00", false)]
        [TestCase("23/06/2003 18:15:00", "15 18 * * Mon", "16/06/2003 18:15:00", false)]
        [TestCase("30/06/2003 18:15:00", "15 18 * * Mon", "23/06/2003 18:15:00", false)]
        [TestCase("07/07/2003 18:15:00", "15 18 * * Mon", "30/06/2003 18:15:00", false)]
        [TestCase("14/07/2003 18:15:00", "15 18 * * Mon", "07/07/2003 18:15:00", false)]

        [TestCase("11/01/2003 00:00:00", "* * * * Mon", "06/01/2003 23:59:00", false)]
        [TestCase("01/12/2003 12:00:00", "45 16 1 * Mon", "01/09/2003 16:45:00", false)]
        [TestCase("01/09/2003 09:45:00", "45 16 1 * Mon", "01/07/2002 16:45:00", false)]

        //// Leap year tests

        [TestCase("01/10/2000 12:00:00", "1 12 29 2 *", "29/02/2000 12:01:00", false)]
        [TestCase("29/02/2000 12:01:00", "1 12 29 2 *", "29/02/1996 12:01:00", false)]
        [TestCase("29/02/2008 12:01:00", "1 12 29 2 *", "29/02/2004 12:01:00", false)]

        //// Non-leap year tests

        [TestCase("01/04/2000 12:00:00", "1 12 28 2 *", "28/02/2000 12:01:00", false)]
        [TestCase("28/02/2005 12:01:00", "1 12 28 2 *", "28/02/2004 12:01:00", false)]
        [TestCase("28/02/2004 12:01:00", "1 12 28 2 *", "28/02/2003 12:01:00", false)]
        [TestCase("28/02/2003 12:01:00", "1 12 28 2 *", "28/02/2002 12:01:00", false)]
        [TestCase("28/02/2002 12:01:00", "1 12 28 2 *", "28/02/2001 12:01:00", false)]
        [TestCase("29/02/2000 12:01:00", "1 12 28 2 *", "28/02/2000 12:01:00", false)]

        [TestCase("01/01/2000 15:00:00", "40 14/1 * * *", "01/01/2000 14:40:00", false)]
        [TestCase("01/01/2000 16:40:00", "40 14/1 * * *", "01/01/2000 15:40:00", false)]

        public void Evaluations_Prev(string startTimeString, string cronExpression, string nextTimeString, bool includingSeconds)
        {
            CronCall_Prev(startTimeString, cronExpression, nextTimeString, new ParseOptions
            {
                IncludingSeconds = includingSeconds
            });
        }
        ...
        public void FiniteOccurrences_Next(string cronExpression, string startTimeString, string endTimeString, bool includingSeconds)
        {
            CronFinite_Next(cronExpression, startTimeString, endTimeString, new ParseOptions
            {
                IncludingSeconds = includingSeconds
            });
        }
        ...
        [TestCase(" *  * * * *  ", "01/01/2003 00:00:00", "01/01/2003 00:00:00", false)]
        [TestCase(" *  * * * *  ", "01/01/2003 00:00:00", "31/12/2002 23:59:59", false)]
        [TestCase(" *  * * * Mon", "01/01/2003 00:00:00", "31/12/2002 23:59:59", false)]
        [TestCase(" *  * * * Mon", "02/01/2003 00:00:00", "01/01/2003 00:00:00", false)]
        [TestCase(" *  * * * Mon", "02/01/2003 12:00:00", "01/01/2003 00:00:00", false)]
        [TestCase("30 12 * * Mon", "06/01/2003 12:00:00", "01/01/2003 00:00:00", false)]

        [TestCase(" *  *  * * * *  ", "01/01/2003 00:00:00", "01/01/2003 00:00:00", true)]
        [TestCase(" *  *  * * * *  ", "01/01/2003 00:00:00", "31/12/2002 23:59:59", true)]
        [TestCase(" *  *  * * * Mon", "01/01/2003 00:00:00", "31/12/2002 23:59:59", true)]
        [TestCase(" *  *  * * * Mon", "02/01/2003 00:00:00", "01/01/2003 00:00:00", true)]
        [TestCase(" *  *  * * * Mon", "02/01/2003 12:00:00", "01/01/2003 00:00:00", true)]
        [TestCase("10 30 12 * * Mon", "06/01/2003 12:00:10", "01/01/2003 00:00:00", true)]

        public void FiniteOccurrences_Prev(string cronExpression, string startTimeString, string endTimeString, bool includingSeconds)
        {
            CronFinite_Prev(cronExpression, startTimeString, endTimeString, new ParseOptions
            {
                IncludingSeconds = includingSeconds
            });
        }
        ...
        public void DontLoopIndefinitely_Next(string expression, bool includingSeconds)
        {
            CronFinite_Next(expression, "01/01/2001 00:00:00", "01/01/2010 00:00:00", new ParseOptions
            {
                IncludingSeconds = includingSeconds
            });
        }
        ...
        [TestCase("* * 31 Feb *", false)]
        [TestCase("* * * 31 Feb *", true)]
        public void DontLoopIndefinitely_Prev(string expression, bool includingSeconds)
        {
            CronFinite_Prev(expression, "01/01/2010 00:00:00", "01/01/2001 00:00:00", new ParseOptions
            {
                IncludingSeconds = includingSeconds
            });
        }
        ...
        static void CronCall_Next(string startTimeString, string cronExpression, string nextTimeString, ParseOptions options)
        {
        ...
        static void CronCall_Prev(string startTimeString, string cronExpression, string nextTimeString, ParseOptions options)
        {
            var schedule = CrontabSchedule.Parse(cronExpression, options);
            var next = schedule.GetPrevOccurrence(Time(startTimeString));

            Assert.AreEqual(nextTimeString, TimeString(next),
                "Occurrence of <{0}> before <{1}>.", cronExpression, startTimeString);
        }

        static void CronFinite_Next(string cronExpression, string startTimeString, string endTimeString, ParseOptions options)
        {
            var schedule = CrontabSchedule.Parse(cronExpression, options);
        ...
        static void CronFinite_Prev(string cronExpression, string startTimeString, string endTimeString, ParseOptions options)
        {
            var schedule = CrontabSchedule.Parse(cronExpression, options);
            var occurrence = schedule.GetPrevOccurrence(Time(startTimeString), Time(endTimeString));
